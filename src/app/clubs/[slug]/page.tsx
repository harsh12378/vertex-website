...
const clubs = [
  ...
  { 
    ...
    activities: [
        ...
        { name: 'Literary Arts', description: 'Engaging the community with the power of words through poetry slams, debates, storytelling sessions, and creative writing workshops.', icon: '✍' }
    ],
    goals: [
  ...
  { 
    ...
    events: [
      { name: 'Indoor Games', description: 'Strategy and skill come alive with tournaments in chess, carrom, table tennis, and more.', icon: '♟' },
  ...
  { 
    ...
    keyRoles: [
      ...
      { name: 'Reputation Management', description: 'Monitoring our public perception and developing strategies to enhance our brand and reputation.', icon: '🛡' }
    ],
    responsibilities: [
